...
function App() {
  ...
  //   ['Matcha Maiko', 'KIJITORA', "Nana's Green Tea"].includes(cafe.name)
  // );
  const normalize = str =>
    str
      .trim()
  ...
  const cafeImages = {
    ...
    "Nana's Green Tea": "/cafe_photos/nanas-1.png",
...
return (
  <div className="App">
    ...
    <div className="hero-section">
      <div className="hero-text centered">
        ...
        <div>
          <button
            onClick={() => window.location.assign('/find-matcha.js')}
            style={{
              padding: '12px 24px',
  ...
  <div className="cafe-showcase">
      ...
      <div key={cafe.id} className="cafe-card">
        ...
        <div className={`cafe-image`}>
          <img className = 'cafe-image'
            src={cafeImages[cafe.name] || '/cafe_photos/matchamaiko.jpg'} 
            alt={cafe.name} 
          />
    ...
    <footer>
      <div>
        {/* align to the left + add padding + remove hyper link */}
         <div className="footer-links">
          <a href="#map">Matcha Map</a>
          </div>
          <div className="footer-links">
          <a href="#map">Ranking Cafes</a>
          </div>
          <div className="footer-links">
          <a href="#map">About</a>
          </div>
        ...
        <hr  style={{ margin: '24px 0', border: 'none', borderTop: '10px' }} />
